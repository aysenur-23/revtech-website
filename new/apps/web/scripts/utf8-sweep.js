...
(function main(){
  console.log('🔍 UTF-8 Sweep başlatılıyor...');
  for (const dir of dirs) walk(path.join(process.cwd(), dir));
  console.log(`✅ UTF-8 SWEEP SUMMARY -> scanned: ${scanned}, converted: ${converted}, skipped: ${skipped}`);
})();
