...
export function CTA() {
  return (
    <section aria-labelledby="cta-heading" className="py-20 md:py-32 relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-800 transition-all duration-700">
      {/* Background Effects */}
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          <h2 id="cta-heading" className="text-3xl md:text-5xl font-bold leading-tight text-white">
            Enerji Geleceğinizi{' '}
            <span className="bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
              Şekillendirin
            </span>
          </h2>
          <p className="mx-auto mt-8 max-w-prose text-base md:text-lg text-white/90">
            Revium ile sürdürülebilir enerji çözümlerine geçin. 
            Danışmanlık için hemen iletişime geçin ve enerji tasarrufuna başlayın.
          </p>
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Button asChild variant="outline" size="lg" className="inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm md:text-base font-medium border border-neutral-300 text-neutral-900 bg-transparent hover:bg-neutral-50/50 focus-visible:ring-2">
