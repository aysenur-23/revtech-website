...
import { Battery, Zap, Shield, ArrowRight, Home } from 'lucide-react'
import Link from 'next/link'
import Image from 'next/image'
import { ui, cn } from '@/lib/ui.config'

const products = getProductsByCategory('cabin')
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-6xl font-bold leading-tight text-slate-900">
                  <span className="block">Kabin Tipi</span>
                ...
                <p className="text-xl text-slate-600 leading-relaxed">
                  Sabit kurulum için tasarlanmış yüksek kapasiteli enerji depolama sistemleri. 
                  Endüstriyel ve ticari uygulamalar için güvenilir enerji çözümleri.
                </p>
              </div>
            ...
            <div className="relative w-full h-96 lg:h-[500px]">
              <Image
                src="/images/products/cabin-power.png"
                alt="Kabin Tipi Güç Paketleri"
                fill
        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Sabit Kurulum</h3>
              <p className="text-slate-600 leading-relaxed">
                Endüstriyel ve ticari uygulamalar için optimize edilmiş sabit kurulum çözümleri.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Yüksek Kapasite</h3>
              <p className="text-slate-600 leading-relaxed">
                21.6 kWh gibi yüksek enerji kapasitesi ile uzun süreli enerji ihtiyaçlarını karşılar.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Modüler Tasarım</h3>
              <p className="text-slate-600 leading-relaxed">
                Genişletilebilir modüler yapı ile ihtiyaca göre kapasite artırımı mümkün.
              </p>
            </div>
          </div>
        </div>
          ...
          {products.length > 0 ? (
                ...
                <Link key={product.slug} href={`/tr/urunlerimiz/${product.slug}`} className="block group">
                  <Card className="overflow-hidden relative h-full flex flex-col hover-lift">
                    <div className="relative h-64 w-full overflow-hidden">
                      <Image
                        src={product.images[0] || '/images/products/cabin-power.png'}
                        alt={product.name}
                        fill
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge className="bg-emerald-500 text-white">
                          {product.capacity_kwh} {product.capacity_kwh !== 'Modüler' && 'kWh'}
                        </Badge>
                      </div>
                    </div>
                    <CardHeader className="flex-grow">
                      ...
                      <CardDescription className={ui.typography.body}>
                        {product.capacity_kwh === 'Modüler' ? 'Modüler genişletilebilir' : product.capacity_kwh + ' kWh'} kapasite, {Array.isArray(product.output_w) ? product.output_w[0] : product.output_w} güç çıkışı
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3 mb-6">
                        <div className="flex items-center gap-2 text-sm text-neutral-600">
                          ...
                          <span>{product.capacity_kwh === 'Modüler' ? 'Genişletilebilir Kapasite' : product.capacity_kwh + ' kWh Kapasite'}</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-neutral-600">
                          <Zap className="h-4 w-4 text-emerald-500" />
                          <span>{Array.isArray(product.output_w) ? product.output_w[0] : product.output_w} Güç</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-neutral-600">
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">
                Kabin Tipi Güç Paketleri Yakında!
              </h3>
              <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
                Sabit kurulum için tasarlanmış yüksek kapasiteli enerji depolama sistemlerimiz yakında sizlerle buluşacak.
              </p>
        ...
        <div className="container-app">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="h2 text-neutral-900 mb-6">
              Kabin Tipi Enerji Çözümünüzü{' '}
              <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">
                Keşfedin
              </span>
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-12">
              Uzman ekibimizle iletişime geçin ve size en uygun kabin tipi güç paketini bulalım.
            </p>
