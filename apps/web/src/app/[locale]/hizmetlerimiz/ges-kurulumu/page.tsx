...
export default function GESKurulumuPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
      ...
      {/* Features Section */}
      <section id="features" className="section bg-white py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 ${features.length === 1 ? 'max-w-sm mx-auto' :
            ...
            {features.map((feature, index) => (
              <div key={index} className={`bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group ${features.length === 3 ? 'w-full max-w-sm' : ''
                }`}>
      ...
      {/* Process Section */}
      <section className="section bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 sm:mb-6">
