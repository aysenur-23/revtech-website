...
export default function GesPowerStationPage() {
  ...
  const product = {
    ...
    applications: loading ? [
      ...
      t('productDetails.gesPowerStation.applications.residential'),
      t('productDetails.gesPowerStation.applications.commercial'),
      t('productDetails.gesPowerStation.applications.industrial'),
      t('productDetails.gesPowerStation.applications.solarFarms'),
      t('productDetails.gesPowerStation.applications.offGrid'),
      t('productDetails.gesPowerStation.applications.hybrid')
    ]
  }
