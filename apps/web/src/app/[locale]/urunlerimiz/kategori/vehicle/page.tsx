...
import { Battery, Zap, Shield, ArrowRight, Truck } from 'lucide-react'
import Link from 'next/link'
import Image from 'next/image'
import { ui, cn } from '@/lib/ui.config'

const products = getProductsByCategory('vehicle')
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-6xl font-bold leading-normal text-slate-900 py-2">
                  <span className="block">Araç Tipi</span>
                ...
                <p className="text-xl text-slate-600 leading-relaxed">
                  Bir aracın tamamı olabildiğince güç kaynağı dolu sistemler. 
                  Zorlu araç koşullarına dayanıklı, güvenilir performans.
                </p>
              </div>
            ...
            <div className="relative w-full h-96 lg:h-[500px]">
              <Image
                src="/images/products/hilux-21-6kwh-1.png"
                alt="Araç Tipi Güç Paketleri"
                fill
        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Araç Entegrasyonu</h3>
              <p className="text-slate-600 leading-relaxed">
                Araçlara özel tasarım ile mükemmel entegrasyon. Zorlu araç koşullarına dayanıklı yapı.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                21.6 kWh'den 200 kWh'ye kadar geniş kapasite seçenekleri ile her ihtiyaca uygun çözüm.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                UNIMOG gibi savunma sanayi araçları için özel tasarım güçlü enerji sistemleri.
              </p>
            </div>
          </div>
        </div>
              ...
              <Link key={product.slug} href={`/tr/urunlerimiz/${product.slug}`} className="block group">
                <Card className="overflow-hidden relative h-full flex flex-col hover-lift">
                  <div className={`relative h-64 w-full overflow-hidden ${
                    product.slug === 'r-u200000' ? 'bg-transparent' : ''
                  }`}>
                    <Image
                      src={product.images[0] || '/images/products/hilux-21-6kwh-1.png'}
                      alt={product.name}
                      fill
                      className={`transition-transform duration-500 group-hover:scale-110 ${
                        product.slug === 'r-u200000' ? 'object-contain' : 'object-cover object-top'
                      }`}
        ...
        <div className="container-app">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="h2 text-neutral-900 mb-6">
              Araç Tipi Enerji Çözümünüzü{' '}
              <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">
                Keşfedin
              </span>
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-12">
              Uzman ekibimizle iletişime geçin ve size en uygun araç tipi güç paketini bulalım.
            </p>
