...
export default function SolarVoltwagonPage() {
  ...
  const product = {
    ...
    applications: loading ? [
      ...
      t('productDetails.solarVoltwagon.applications.vehicles'),
      t('productDetails.solarVoltwagon.applications.mobile'),
      t('productDetails.solarVoltwagon.applications.camping'),
      t('productDetails.solarVoltwagon.applications.emergency'),
      t('productDetails.solarVoltwagon.applications.commercial'),
      t('productDetails.solarVoltwagon.applications.offGrid')
    ]
  }
