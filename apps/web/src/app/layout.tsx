  ...
  return (
    <html lang="tr" suppressHydrationWarning>
      <head>
        ...
        {/* Hero video erken yüklensin; as=fetch ile tarayıcı uyumlu */}
        <link rel="preload" href="/videos/hero-new.mp4" as="fetch" fetchPriority="high" />
        <link rel="preload" as="image" href="/images/hero/revium-hero-2-7kwh.jpg" fetchPriority="high" />
      </head>
